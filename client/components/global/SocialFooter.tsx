...
export const SocialFooter = () => {
  ...
  return (
    <section id="connect" ref={footerRef} className="w-full relative z-0 overflow-visible min-h-screen flex flex-col px-6 md:px-16 lg:px-24 bg-[#050505]">
      ...
      */}
      <div className="absolute inset-0 z-[-5] opacity-100 pointer-events-none md:pointer-events-auto" style={{ filter: 'brightness(3.0) contrast(1.15)' }}>
        {isInView && (
          <SplineWrapper 
      ...
      <div className="relative z-10 w-full flex-1 flex flex-col justify-between py-12 md:py-16 gap-16 min-h-screen pointer-events-none">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
          ...
          <div className="lg:col-span-5 space-y-12 pointer-events-auto">
            <div className="space-y-8">
              <h2 className="text-7xl md:text-8xl lg:text-[9rem] font-black font-sans text-white uppercase tracking-tighter leading-[0.75] mb-6">
                Let's <br />
                <span className="text-red-300 font-black">Sync.</span>
              </h2>
              <p className="text-white/40 text-xl md:text-3xl max-w-xl font-sans font-medium leading-[1.6] tracking-tight">
          ...
          <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-10 auto-rows-[200px] md:auto-rows-[220px] pointer-events-auto">
            {/* Email - Large Bento */}
            <BentoLink 
              name="Email" 
            ...
            <BentoLink 
              ...
              Icon={FaGithub}
              className="col-span-2 md:col-span-1 bg-white/5 border-white/10 hover:bg-slate-800 hover:border-slate-700 hover:text-white"
            />
            ...
            <BentoLink 
              ...
              Icon={FaLinkedinIn}
              className="col-span-2 md:col-span-1 bg-white/5 border-white/10 hover:bg-blue-600 hover:border-blue-500 hover:text-white"
            />
        ...
        <div className="w-full mb-10 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 relative z-10 transition-opacity hover:opacity-100 opacity-65 pointer-events-auto">
          <div className="flex gap-6 font-mono text-[11px] uppercase tracking-[0.2em] text-white">
            <span>Local Time // {mounted ? new Date().toLocaleTimeString() : "--:--:--"}</span>
          </div>
          <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-white text-center">
             © 2026 MIHIR PATIL // ALL SYSTEMS OPERATIONAL
          </p>
          <div className="flex gap-12 font-mono text-[11px] uppercase tracking-[0.2em] text-white">
    ...
    >
      ...
      <div className="relative z-10 flex flex-col justify-between h-full p-8 md:p-10">
        ...
        <div className="flex items-start justify-between">
          <Icon className="text-3xl text-white/40 group-hover:text-white transition-colors" />
          <svg className="w-5 h-5 opacity-20 group-hover:opacity-100 transition-all duration-500 transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="space-y-1 mt-auto">
          <h4 className="font-mono text-[10px] uppercase tracking-[0.3em] text-white/40 group-hover:text-white/60 transition-colors">
            {name}
          </h4>
          <p className="text-base md:text-lg font-bold text-white uppercase tracking-tight truncate leading-tight">
            {handle}
          </p>
        </div>
      </div>
